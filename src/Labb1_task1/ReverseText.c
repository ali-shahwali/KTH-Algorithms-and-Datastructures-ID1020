...
therefore get the sequence of characters in reverse order when jumping back in every instance
*/
...
'str's address forward until a newline is fed in. then we enter the next while loop and use putchar to place each char in 'str'
